<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="$t('toolkits.usingData')"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="$t('toolkits.usingData')">
      ...
      <FacilitationGuide :toolkit="$t('toolkits.usingData')">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="$t('toolkits.usingData')">
      ...
      <AdditionalResources :toolkit="$t('toolkits.usingData')"></AdditionalResources>
    </div>
  </main>
</template>
