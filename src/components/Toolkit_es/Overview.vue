<template>
  <main class="workshop workshop__Overview">
    ...
    <div class="workshop_content">
      ...
      <p>También agradecemos a <a href="https://www.queerblackediting.com/">Queer Black Editing</a> por las correcciones al manual, y [NOMBRES DE LOS TRADUCTORES] por su traducción. Este proyecto no habría sido posible sin el generoso apoyo de Surdna Foundation.
