<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="overviewToolkit[0]"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="overviewToolkit[0]">
      ...
      <FacilitationGuide :toolkit="overviewToolkit[0]">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="overviewToolkit[0]">
      ...
      <AdditionalResources :toolkit="overviewToolkit[0]"></AdditionalResources>
    </div>
  </main>
</template>
