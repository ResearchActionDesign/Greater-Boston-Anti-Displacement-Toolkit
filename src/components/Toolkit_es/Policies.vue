      ...
      <FacilitationGuide :toolkit="toolkit">
        ...
        <template slot="Materials_and_Preparation">
          <ul>
            ...
            <li>Imprimir hojas de trabajo en blanco de diálogos (AQUI <b>TODO: LINK</b>) para cada participante.</li>
            <li>Imprimir ejemplos de hojas de trabajo (AQUÍ <b>TODO: LINK</b>) para cada facilitador/a/e. <strong>Nota</strong> : Si es útil, los ejemplos de la hoja de trabajo se pueden imprimir y compartir con los participantes.</li>
