<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="$t('toolkits.policies')"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="$t('toolkits.policies')">
      ...
      <FacilitationGuide :toolkit="$t('toolkits.policies')">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="$t('toolkits.policies')">
      ...
      <AdditionalResources :toolkit="$t('toolkits.policies')"></AdditionalResources>
    </div>
  </main>
</template>
