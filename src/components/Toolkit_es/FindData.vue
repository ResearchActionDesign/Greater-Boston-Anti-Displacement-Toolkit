<template>
  <main class="workshop">
    ...
    <div class="workshop_content">
      ...
      <FacilitationGuide :toolkit="$t('toolkits.findingData')">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="$t('toolkits.findingData')">
      ...
      <AdditionalResources :toolkit="$t('toolkits.findingData')"></AdditionalResources>
    </div>
  </main>
</template>
