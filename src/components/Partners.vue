<template>
    <article>
        ...
        <span class="partnersMessage">
            <p> <strong>This project was funded by the Surdna Foundation,</strong> and was a collaboration between GreenRoots, 
            the Everett Community Health Partnership (ECHP), Research Action Design (RAD), and MIT CoLab.</p>
            <p> <strong>Creative Commons Attribution:</strong> This license lets you remix, tweak, and build upon this work non-
            commercially, as long as you credit us and license your new creations under the identical terms.</p>
