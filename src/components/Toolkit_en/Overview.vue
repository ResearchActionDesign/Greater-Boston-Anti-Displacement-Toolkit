<template>
    ...
    <ToolkitIntro :toolkit="$t('overviewToolkit')"></ToolkitIntro>
      ...
      <p>Chelsea and Everett, Massachusetts are facing pressure from developers, resulting in land being swallowed up by investors and increased housing prices, and the forced displacement (or pushing-out) of residents and small businesses. Healthy Neighborhoods Study (HNS)—which aims to understand the relationship between development, neighborhood conditions, and health across nine communities in Massachusetts. Documented research from 2016-2019 indicates that 40% of Chelsea and 31% of Everett survey respondents expect to move in the next five years; of that research, 72% of Chelsea and 75% of Everett respondents indicated that they are proud to live in their community. However, the impact of displacement will negatively affect these respondents, other individuals, families, and communities. To learn more about displacement, including its impact on health, educational outcomes, and community power, go to the Resources section for Pushed Out, a short video produced by Urban Displacement Project.</p>
      ...
      <h2>Who was involved in creating the Greater Boston Anti-Displacement Toolkit?</h2>
