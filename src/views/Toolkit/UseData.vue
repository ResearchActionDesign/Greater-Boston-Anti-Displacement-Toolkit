<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="toolkits[2]"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="toolkits[2]">
      ...
      <FacilitationGuide :toolkit="toolkits[2]">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="toolkits[2]">
      ...
      <AdditionalResources :toolkit="toolkits[2]"></AdditionalResources>
    </div>
  </main>
</template>
