<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="toolkits[1]"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="toolkits[1]">
      ...
      <FacilitationGuide :toolkit="toolkits[1]">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="toolkits[1]">
      ...
      <AdditionalResources :toolkit="toolkits[1]"></AdditionalResources>
    </div>
  </main>
</template>
