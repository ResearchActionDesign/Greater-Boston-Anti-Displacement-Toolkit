<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="toolkits[5]"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="toolkits[5]">
      ...
      <FacilitationGuide :toolkit="toolkits[5]">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="toolkits[5]">
      ...
      <AdditionalResources :toolkit="toolkits[5]"></AdditionalResources>
    </div>
  </main>
</template>
