<template>
  <main class="workshop">
    <ToolkitIntro :toolkit="toolkits[3]"></ToolkitIntro>

    <div class="workshop_content">
      <Introduction :toolkit="toolkits[3]">
      ...
      <FacilitationGuide :toolkit="toolkits[3]">
        <!-- Purpose and Outcome -->
      ...
      <TakingAction :toolkit="toolkits[3]">
      ...
      <AdditionalResources :toolkit="toolkits[3]"></AdditionalResources>
    </div>
  </main>
</template>
